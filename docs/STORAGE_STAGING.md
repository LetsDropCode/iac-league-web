...
- The labelled synthetic CSV passed preview and real UI import, producing one runner on 20 points. Its 12-file checkpoint then survived both an actual service restart and full redeploy with identical inventory/standings/rules digests and disk device. Scheduled-hourly-backup verification remains.
